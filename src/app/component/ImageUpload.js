...
const ImageUpload = () => {
  ...
  return (
    <div className="w-full h-full flex flex-row justify-center items-center align-middle">
      <form onSubmit={handleSubmit}  className="bg-green-200 w-1/2 h-full flex flex-col justify-center items-center align-middle">
        ...
        <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white" htmlFor="image">Upload an image with a clear background</label>
        <input onChange={inputHandler}  className="block w-[70%] text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="image" name="file" accept="image/*" type="file"/>
        <button type="submit" className="mt-3 bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full">Upload...</button>
      </form>
